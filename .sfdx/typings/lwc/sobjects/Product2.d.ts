...
declare module "@salesforce/schema/Product2.Additional_Details__c" {
  const Additional_Details__c:string;
  export default Additional_Details__c;
}
declare module "@salesforce/schema/Product2.Height__c" {
  const Height__c:string;
  export default Height__c;
}
declare module "@salesforce/schema/Product2.Width__c" {
  const Width__c:string;
  export default Width__c;
}
declare module "@salesforce/schema/Product2.Depth__c" {
  const Depth__c:string;
  export default Depth__c;
}
declare module "@salesforce/schema/Product2.Diameter__c" {
  const Diameter__c:string;
  export default Diameter__c;
}
declare module "@salesforce/schema/Product2.Weight__c" {
  const Weight__c:string;
